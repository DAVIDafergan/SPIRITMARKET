...
            
            // Users Table (No Change, rating is updated separately)
...
            // Listings Table (Added view_count)
            await connection.query(`
...
                    ai_data JSON,
                    view_count INT DEFAULT 0, -- **חדש: מניית צפיות**
                    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
                    FOREIGN KEY (seller_id) REFERENCES users(id) ON DELETE CASCADE
                )
            `);
            
            // Reviews Table (**חדש: דירוג וביקורות**)
            await connection.query(`
...
// 1. GET Listings (Home Page) - ללא שינוי מהותי
...
// 2. POST Create Listing (Protected) - ללא שינוי מהותי
