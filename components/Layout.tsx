...
              )}
              {/* קישור לדף ניהול ליסטינג אישי (MyListings) */}
              {user && (
...
              {/* לוגו בפוטר - שוחזר לטקסט SpiritMarket */}
